...
const Support = () => {
  return (
    <section className='w-full'>
      <div className='h-[700px]  bg-[url("../public/images/support.jpg")]  bg-cover bg-top bg-no-repeat  '>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black mx-auto lg:-mt-96 md:-mt-80 sm:-mt-72 -mt-32 max-w-[1240px]'>
